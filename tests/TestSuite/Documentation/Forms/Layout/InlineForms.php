...
<<<<<<< HEAD:tests/TestSuite/Documentation/Tests/Components/Forms/Layout/InlineForms.php
=======
    'expected' => '<form action="" method="POST" name="form" role="form" class="align-items-center" id="form">' .
        ...
        'Submit</button>' . PHP_EOL .
        '</form>',
>>>>>>> feat: migrate form:tests/TestSuite/Documentation/Forms/Layout/InlineForms.php
    'tests' => [
