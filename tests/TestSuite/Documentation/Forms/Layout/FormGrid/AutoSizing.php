...
<<<<<<< HEAD:tests/TestSuite/Documentation/Tests/Components/Forms/Layout/FormGrid/AutoSizing.php
=======
    'expected' => '<form action="" method="POST" name="form" role="form" id="form">' . PHP_EOL .
        ...
        '    </div>' . PHP_EOL .
        '</form>',
>>>>>>> feat: migrate form:tests/TestSuite/Documentation/Forms/Layout/FormGrid/AutoSizing.php
];
